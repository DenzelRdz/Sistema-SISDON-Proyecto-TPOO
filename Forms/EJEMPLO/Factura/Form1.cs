...
namespace Factura
{
    public partial class Form1 : Form
    {
        ...
        private void cmbProducto_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (nom)
            {
                case "Tortillas blancas": lblNombre.Text = "blancas";break;
                case "Tortillas amarillas": lblNombre.Text = "amarillas";break;
                default: lblNombre.Text = "Tortillas integral"; break;
            }

            switch (precio)
            {
                case 0: lblPrecio.Text = "15";break;
                case 1: lblPrecio.Text = "20";break;
